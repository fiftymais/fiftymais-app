  ...
  if (type === 'checkout.session.completed') {
    ...
    try {
      ...
      if (existingUser) {
        ...
        if (createError) return res.status(500).send('Erro ao criar usuário');
...
.cred-value{font-size:18px;font-weight:bold;color:#111;font-family:monospace;display:block;margin-bottom:16px}
...
<div class="container">
  ...
  <div class="body">
    ...
    <p class="text">Seu pagamento foi confirmado! Seu acesso está <strong>ativo agora mesmo</strong>. Aqui estão suas credenciais:</p>
    ...
    <p class="text" style="font-size:13px;color:#999">Guarde estas informações em local seguro. Você pode alterar a senha dentro do app.</p>
  </div>
  <div class="footer">
    <p>© ${new Date().getFullYear()} Fifty+ • contato@fiftymais.com.br</p>
  </div>
</div>
</body>
</html>`;
